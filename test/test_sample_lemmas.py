#!/usr/bin/env python3
# test_sample_lemmas.py - test DWDSmor lemmas against sample lexicon
...
@fixture
def output_file():
    return path.join(REPORTDIR, "sample-lemmas.tsv")
...
def test_sample_lemmas(transducer, data_files, output_file):
