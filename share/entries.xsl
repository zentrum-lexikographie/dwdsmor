      ...
      <xsl:otherwise>
        ...
        <xsl:choose>
          ...
          <xsl:when test="$lemma-without-particle='bedürfen' or
            ...
            <!-- old spellings -->
            <xsl:if test="matches($present-stem,'ss$')">
              <xsl:call-template name="verb-entry">
                <xsl:with-param name="lemma"
                                select="$lemma-without-particle"/>
                <xsl:with-param name="lemma-index"
            ...
            <xsl:if test="matches($stem,'ss$')"><!-- sic! -->
              <xsl:call-template name="verb-entry">
                <xsl:with-param name="lemma"
                                select="$lemma-without-particle"/>
                <xsl:with-param name="lemma-index"
          ...
          <xsl:when test="matches($past-without-particle,concat('^',$past-stem,'e?te$'))">
            ...
            <xsl:choose>
              ...
              <xsl:otherwise>
                ...
                <!-- old spellings -->
                <xsl:if test="matches($past-stem,'ss$')">
                  <xsl:call-template name="verb-entry">
                    <xsl:with-param name="lemma"
                                    select="$lemma-without-particle"/>
                    <xsl:with-param name="lemma-index"
              ...
              <xsl:when test="matches($past-stem,'([aou]|aa|oo|au)[^aeiouäöü]*$')">
                ...
                <xsl:if test="matches($past-stem,'ss$')">
                  <xsl:call-template name="verb-entry">
                    ...
                    <xsl:with-param name="stem"
                                    select="n:ss-sz-alternation($past-stem)"/>
                    <xsl:with-param name="class">VVPastIndStr-s</xsl:with-param>
                    <xsl:with-param name="etymology"
                                    select="$etymology"/>
                  </xsl:call-template>
                </xsl:if>
              ...
              <xsl:otherwise>
                ...
                <xsl:if test="matches($past-stem,'ss$')">
                  <xsl:call-template name="verb-entry">
                    ...
                    <xsl:with-param name="stem"
                                    select="n:ss-sz-alternation($past-stem)"/>
                    <xsl:with-param name="class">VVPastStr-s</xsl:with-param>
                    <xsl:with-param name="etymology"
                                    select="$etymology"/>
                  </xsl:call-template>
                </xsl:if>
          ...
          <xsl:when test="matches($participle-without-particle,'e?t$')">
            <xsl:choose>
              ...
              <xsl:otherwise>
                ...
                <!-- old spellings -->
                <xsl:if test="matches($participle-stem,'ss$')">
                  <xsl:call-template name="verb-entry">
                    <xsl:with-param name="lemma"
                                    select="$lemma-without-particle"/>
                    <xsl:with-param name="lemma-index"
